...
(function () {
    ...
    Printful_Product_Customizer = {
        ...
        onCustomizeClick: function (site_url) {
	                if(document.getElementById("pa_color").value === "" && document.getElementById("pa_size").value === ""){
                alert("please select a size and color");
                return;
            }
            if(document.getElementById("pa_color").value === ""){
                alert("please select a color");
                return;
            }
            if(document.getElementById("pa_size").value === ""){
